...
* 
* 이러면 array라는 이름의 배열은 5개의 int형식의 변수를 보관하고 있을 겁니다. (4page)
 ...
 * 1차원 배열의 선원과 크게 차이는 없고 크기 하나만 더 적어주면 됩니다.
 * ==============================================================
 ...
 * 위치 인덱스를 찾아 입력한 곳은 0,0은 1 / 0,3은 4 / 1,3은 3/ 3,2은 2.이렇게 됩니다.(7 page)
 ...
 * 그럼 다음에는 반복문을 사용해서 맵을 표현하는 실습을 해볼까요?
 */
/* 3. 반복문과 함께하는 배열의 활용
 ...
 * ==============================================================
 * 이렇게 말이에요.
 * 그럼 이 카운트다운을 배열을 이용해 for문을 진행해보겠습니다.
 * (작성)
 * 먼저 countdown 배열을 선언하고 초기화 해줍니다.
 * 그리고 for문으로 배열의 인덱스의 반복을 설정하고 출력하도록 구현해보겠습니다. (8page)
 * ==============================================================
 ...
 * 이 그림처럼 우리는 2차원배열에서 세로를 먼저 입력한다는 것을 기억합시다. (9 page)
 * (작성)
 * 다시 이어서 작성해볼께요.
 * 우리는 y가 0인 순간에 x도 있어야 온전한 위치를 알 수 있습니다. 따라서 for문을 한번 더 작성할 겁니다.
 ...
 * 
 * 배열을 어떤식으로 활요하게 될지 한 번 고민해 보는 시간이 되시길 바랍니다.  
 */
/* 4. 배열과 타입
 ...
 * }
 * ==============================================================
 * 그러면 배열이니까 당연히 인덱스로도 출력할 수 있습니다.
 * for문으로 구현해 보겠습니다.
 * ==============================================================
 ...
 * 
 * 이번에는 또 다른 자료형인 var에 대해 알아보겠습니다.
 ...
 * 그때 만약 개발자가 착각하게 된다면, 코드는 그대로 에러를 발생시킬겁니다.(10 page)
 * 이런식으로 복잡해진 코드 속 자료형을 잘못 지정해서 에러가 나는 상황을 피하기위해 var를 사용할 수 있습니다.
